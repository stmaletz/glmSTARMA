...
class Model
{
    ...
    static double log_likelihood(const arma::vec &x, arma::vec &score, arma::mat &information, const arma::vec &ts_vec, Design * design, const Orders * orders, Neighborhood * W_ma, const Family * family, bool calc_score, bool calc_information, const unsigned int &n_obs);
